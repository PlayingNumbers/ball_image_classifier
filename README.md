...
In colab, running the code should create the folder structure that you need. Drag and drop the photos that are attached into their respective folders. Technically you could skip the the folder creation and just drag and drop the data from the repo into the colab file destination
